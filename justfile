...
export JENA_MAIN_GIT_COMMIT_ID := env_var_or_default('JENA_MAIN_GIT_COMMIT_ID','1c34284e')
...
# Apache Jena recipes
build-jena: build-jena-main-17 build-jena-main-20 build-jena-release-4_8
