...
export KOTLIN_VER := env_var_or_default('KOTLIN_VER','2.2.21')
export SCALA_VER := env_var_or_default('SCALA_VER','3.7.4')
export ANT_VER := env_var_or_default('ANT_VER','1.10.14')
export GRADLE_VER := env_var_or_default('GRADLE_VER','9.2.0')
...
export CASSANDRA_TRUNK_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_TRUNK_GIT_COMMIT_ID','99be618e')
...
export JENA_MAIN_GIT_COMMIT_ID := env_var_or_default('JENA_MAIN_GIT_COMMIT_ID','0c00f119')
...
export SPARK_MASTER_GIT_COMMIT_ID := env_var_or_default('SPARK_MASTER_GIT_COMMIT_ID','0a42f557')
...
export SPARK_RELEASE_4_0_GIT_COMMIT_ID := env_var_or_default('SPARK_RELEASE_4_0_GIT_COMMIT_ID','v4.0.1')
export SPARK_RELEASE_4_0_DISTRO_VERSION := env_var_or_default('SPARK_RELEASE_4_0_DISTRO_VERSION','4.0.1')
export SPARK_RELEASE_3_5_PARENT_TAG := env_var_or_default('SPARK_RELEASE_3_5_PARENT_TAG','17')
export SPARK_RELEASE_3_5_GIT_COMMIT_ID := env_var_or_default('SPARK_RELEASE_3_5_GIT_COMMIT_ID','v3.5.7')
export SPARK_RELEASE_3_5_DISTRO_VERSION := env_var_or_default('SPARK_RELEASE_3_5_DISTRO_VERSION','3.5.7')
