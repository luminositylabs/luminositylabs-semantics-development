...
export UBUNTU_TAG := env_var_or_default('UBUNTU_TAG','noble-20241011')
export JAVA_VER_DISTRO_8 := env_var_or_default('JAVA_VER_DISTRO_8','8.0.432-zulu')
...
export KOTLIN_VER := env_var_or_default('KOTLIN_VER','2.0.21')
...
export GRADLE_VER := env_var_or_default('GRADLE_VER','8.10.2')
export MAVEN_VER := env_var_or_default('MAVEN_VER','3.9.9')
export SBT_VER := env_var_or_default('SBT_VER','1.10.2')
...
export CASSANDRA_TRUNK_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_TRUNK_GIT_COMMIT_ID','f90a6ca3')
...
export CASSANDRA_RELEASE_5_0_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_RELEASE_5_0_GIT_COMMIT_ID','cassandra-5.0.0')
export CASSANDRA_RELEASE_5_0_DISTRO_VERSION := env_var_or_default('CASSANDRA_RELEASE_5_0_DISTRO_VERSION','5.0.0')
...
export JENA_MAIN_GIT_COMMIT_ID := env_var_or_default('JENA_MAIN_GIT_COMMIT_ID','702a44d8')
...
export JENA_RELEASE_5_1_PARENT_TAG := env_var_or_default('JENA_RELEASE_5_1_PARENT_TAG','17')
export JENA_RELEASE_5_1_GIT_COMMIT_ID := env_var_or_default('JENA_RELEASE_5_1_GIT_COMMIT_ID','jena-5.1.0-ll')
export JENA_RELEASE_5_1_DISTRO_VERSION := env_var_or_default('JENA_RELEASE_5_1_DISTRO_VERSION','5.1.0')
export SPARK_MASTER_GIT_COMMIT_ID := env_var_or_default('SPARK_MASTER_GIT_COMMIT_ID','7de71a2e')
...
export SPARK_RELEASE_3_5_GIT_COMMIT_ID := env_var_or_default('SPARK_MASTER_GIT_COMMIT_ID','v3.5.2')
export SPARK_RELEASE_3_5_DISTRO_VERSION := env_var_or_default('SPARK_MASTER_DISTRO_VERSION','3.5.2')
export WIDOCO_MAIN_GIT_COMMIT_ID := env_var_or_default('WIDOCO_MAIN_GIT_COMMIT_ID','fec66b89')
...
# Apache Jena recipes
build-jena: build-jena-main-17 build-jena-main-21 build-jena-release-4_10 build-jena-release-5_0 build-jena-release-5_1
...
build-jena-release-4_10: build-maven-17
   ...
   if [ "{{do_platform_amd64}}" == "true" ]; then
      time docker image build --platform linux/amd64 --progress plain -f Dockerfile.ubuntu-jena -t  ${IMGTAG}_linux-amd64 --build-arg PREFIX={{prefix}} --build-arg PARENT_TAG=${JENA_RELEASE_4_10_PARENT_TAG}_linux-amd64 --build-arg JENA_GIT_COMMIT_ID=${JENA_RELEASE_4_10_GIT_COMMIT_ID} --build-arg JENA_DISTRO_VERSION=${JENA_RELEASE_4_10_DISTRO_VERSION} --build-arg SKIP_JAVADOCS=true .
      if [[ "{{do_push}}" == "true" ]]; then
         docker push ${IMGTAG}_linux-amd64
      fi
   fi
   if [ "{{do_platform_arm64}}" == "true" ]; then
      time docker image build --platform linux/arm64 --progress plain -f Dockerfile.ubuntu-jena -t  ${IMGTAG}_linux-arm64 --build-arg PREFIX={{prefix}} --build-arg PARENT_TAG=${JENA_RELEASE_4_10_PARENT_TAG}_linux-arm64 --build-arg JENA_GIT_COMMIT_ID=${JENA_RELEASE_4_10_GIT_COMMIT_ID} --build-arg JENA_DISTRO_VERSION=${JENA_RELEASE_4_10_DISTRO_VERSION} --build-arg SKIP_JAVADOCS=true .
      if [[ "{{do_push}}" == "true" ]]; then
         docker push ${IMGTAG}_linux-arm64
      fi
   fi
...
build-jena-release-5_0: build-maven-17
   ...
   if [ "{{do_platform_amd64}}" == "true" ]; then
      time docker image build --platform linux/amd64 --progress plain -f Dockerfile.ubuntu-jena -t  ${IMGTAG}_linux-amd64 --build-arg PREFIX={{prefix}} --build-arg PARENT_TAG=${JENA_RELEASE_5_0_PARENT_TAG}_linux-amd64 --build-arg JENA_GIT_COMMIT_ID=${JENA_RELEASE_5_0_GIT_COMMIT_ID} --build-arg JENA_DISTRO_VERSION=${JENA_RELEASE_5_0_DISTRO_VERSION} --build-arg SKIP_FUSEKI_UI_E2E_TESTS=true .
      if [[ "{{do_push}}" == "true" ]]; then
         docker push ${IMGTAG}_linux-amd64
      fi
   fi
   if [ "{{do_platform_arm64}}" == "true" ]; then
      time docker image build --platform linux/arm64 --progress plain -f Dockerfile.ubuntu-jena -t  ${IMGTAG}_linux-arm64 --build-arg PREFIX={{prefix}} --build-arg PARENT_TAG=${JENA_RELEASE_5_0_PARENT_TAG}_linux-arm64 --build-arg JENA_GIT_COMMIT_ID=${JENA_RELEASE_5_0_GIT_COMMIT_ID} --build-arg JENA_DISTRO_VERSION=${JENA_RELEASE_5_0_DISTRO_VERSION} --build-arg SKIP_FUSEKI_UI_E2E_TESTS=true .
      if [[ "{{do_push}}" == "true" ]]; then
         docker push ${IMGTAG}_linux-arm64
      fi
   fi

build-jena-release-5_1: build-maven-17
   #!/usr/bin/env bash
   if [[ "{{do_platform_amd64}}" == "true" ]]; then MANIFEST_PLATFORMS="${MANIFEST_PLATFORMS} linux-amd64"; fi
   if [[ "{{do_platform_arm64}}" == "true" ]]; then MANIFEST_PLATFORMS="${MANIFEST_PLATFORMS} linux-arm64"; fi
   MANIFEST_PLATFORMS="${MANIFEST_PLATFORMS## }"
   IMGTAG={{prefix}}ubuntu-jena:${JENA_RELEASE_5_1_DISTRO_VERSION}
   if [ "{{do_platform_amd64}}" == "true" ]; then
      time docker image build --platform linux/amd64 --progress plain -f Dockerfile.ubuntu-jena -t  ${IMGTAG}_linux-amd64 --build-arg PREFIX={{prefix}} --build-arg PARENT_TAG=${JENA_RELEASE_5_1_PARENT_TAG}_linux-amd64 --build-arg JENA_GIT_COMMIT_ID=${JENA_RELEASE_5_1_GIT_COMMIT_ID} --build-arg JENA_DISTRO_VERSION=${JENA_RELEASE_5_1_DISTRO_VERSION} --build-arg SKIP_FUSEKI_UI_E2E_TESTS=true .
      if [[ "{{do_push}}" == "true" ]]; then
         docker push ${IMGTAG}_linux-amd64
      fi
   fi
   if [ "{{do_platform_arm64}}" == "true" ]; then
      time docker image build --platform linux/arm64 --progress plain -f Dockerfile.ubuntu-jena -t  ${IMGTAG}_linux-arm64 --build-arg PREFIX={{prefix}} --build-arg PARENT_TAG=${JENA_RELEASE_5_1_PARENT_TAG}_linux-arm64 --build-arg JENA_GIT_COMMIT_ID=${JENA_RELEASE_5_1_GIT_COMMIT_ID} --build-arg JENA_DISTRO_VERSION=${JENA_RELEASE_5_1_DISTRO_VERSION} --build-arg SKIP_FUSEKI_UI_E2E_TESTS=true .
      if [[ "{{do_push}}" == "true" ]]; then
         docker push ${IMGTAG}_linux-arm64
      fi
   fi
