...
export JAVA_VER_DISTRO_25 := env_var_or_default('JAVA_VER_DISTRO_25','25-zulu')
export JBANG_VER := env_var_or_default('JBANG_VER', '0.132.0')
...
export CASSANDRA_TRUNK_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_TRUNK_GIT_COMMIT_ID','70bcaec5')
