...
export UBUNTU_TAG := env_var_or_default('UBUNTU_TAG','noble-20250805')
...
export JAVA_VER_DISTRO_21 := env_var_or_default('JAVA_VER_DISTRO_21','21.0.8-zulu')
export JAVA_VER_DISTRO_24 := env_var_or_default('JAVA_VER_DISTRO_24','24.0.2-zulu')
export JBANG_VER := env_var_or_default('JBANG_VER', '0.130.0')
...
export GRADLE_VER := env_var_or_default('GRADLE_VER','9.0.0')
export MAVEN_VER := env_var_or_default('MAVEN_VER','3.9.11')
export SBT_VER := env_var_or_default('SBT_VER','1.11.6')
...
export CASSANDRA_TRUNK_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_TRUNK_GIT_COMMIT_ID','8c962707')
...
export CASSANDRA_RELEASE_5_0_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_RELEASE_5_0_GIT_COMMIT_ID','cassandra-5.0.4')
export CASSANDRA_RELEASE_5_0_DISTRO_VERSION := env_var_or_default('CASSANDRA_RELEASE_5_0_DISTRO_VERSION','5.0.4')
...
export JENA_MAIN_GIT_COMMIT_ID := env_var_or_default('JENA_MAIN_GIT_COMMIT_ID','ed40acfe')
export JENA_MAIN_DISTRO_VERSION := env_var_or_default('JENA_MAIN_DISTRO_VERSION','5.6.0-SNAPSHOT')
