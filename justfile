...
export GRADLE_VER := env_var_or_default('GRADLE_VER','9.4.1')
export MAVEN_VER := env_var_or_default('MAVEN_VER','3.9.15')
export SBT_VER := env_var_or_default('SBT_VER','1.12.9')
...
export CASSANDRA_TRUNK_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_TRUNK_GIT_COMMIT_ID','7c3dea92')
export CASSANDRA_TRUNK_DISTRO_VERSION := env_var_or_default('CASSANDRA_TRUNK_DISTRO_VERSION','6.0-alpha2-SNAPSHOT')
...
export CASSANDRA_RELEASE_5_0_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_RELEASE_5_0_GIT_COMMIT_ID','cassandra-5.0.7')
export CASSANDRA_RELEASE_5_0_DISTRO_VERSION := env_var_or_default('CASSANDRA_RELEASE_5_0_DISTRO_VERSION','5.0.7')
...
# Apache Jena recipes
build-jena: build-jena-main-21 build-jena-release-5_5
