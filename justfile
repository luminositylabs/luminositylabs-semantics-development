...
export SCALA_VER := env_var_or_default('SCALA_VER','3.8.1')
export ANT_VER := env_var_or_default('ANT_VER','1.10.14')
export GRADLE_VER := env_var_or_default('GRADLE_VER','9.3.1')
export MAVEN_VER := env_var_or_default('MAVEN_VER','3.9.12')
export SBT_VER := env_var_or_default('SBT_VER','1.12.1')
...
export CASSANDRA_TRUNK_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_TRUNK_GIT_COMMIT_ID','cd707ba6')
