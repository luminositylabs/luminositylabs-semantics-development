...
export UBUNTU_TAG := env_var_or_default('UBUNTU_TAG','noble-20260509.1')
export JAVA_VER_DISTRO_8 := env_var_or_default('JAVA_VER_DISTRO_8','8.0.492-zulu')
export JAVA_VER_DISTRO_11 := env_var_or_default('JAVA_VER_DISTRO_11','11.0.31-zulu')
export JAVA_VER_DISTRO_17 := env_var_or_default('JAVA_VER_DISTRO_17','17.0.19-zulu')
export JAVA_VER_DISTRO_21 := env_var_or_default('JAVA_VER_DISTRO_21','21.0.11-zulu')
export JAVA_VER_DISTRO_25 := env_var_or_default('JAVA_VER_DISTRO_25','25.0.3-zulu')
export JAVA_VER_DISTRO_26 := env_var_or_default('JAVA_VER_DISTRO_26','26.0.1-zulu')
export JBANG_VER := env_var_or_default('JBANG_VER', '0.138.0')
export KOTLIN_VER := env_var_or_default('KOTLIN_VER','2.4.0')
export SCALA_VER := env_var_or_default('SCALA_VER','3.8.4')
export ANT_VER := env_var_or_default('ANT_VER','1.10.17')
export GRADLE_VER := env_var_or_default('GRADLE_VER','9.5.1')
export MAVEN_VER := env_var_or_default('MAVEN_VER','3.9.16')
export SBT_VER := env_var_or_default('SBT_VER','1.12.11')
...
export CASSANDRA_TRUNK_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_TRUNK_GIT_COMMIT_ID','dc7935be')
...
export CASSANDRA_RELEASE_5_0_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_RELEASE_5_0_GIT_COMMIT_ID','cassandra-5.0.8')
export CASSANDRA_RELEASE_5_0_DISTRO_VERSION := env_var_or_default('CASSANDRA_RELEASE_5_0_DISTRO_VERSION','5.0.8')
...
export JENA_MAIN_GIT_COMMIT_ID := env_var_or_default('JENA_MAIN_GIT_COMMIT_ID','c02e6ed7')
