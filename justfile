...
export UBUNTU_TAG := env_var_or_default('UBUNTU_TAG','jammy-20231004')
...
export JAVA_VER_DISTRO_21 := env_var_or_default('JAVA_VER_DISTRO_21','21-zulu')
export KOTLIN_VER := env_var_or_default('KOTLIN_VER','1.9.10')
...
export GRADLE_VER := env_var_or_default('GRADLE_VER','8.4')
export MAVEN_VER := env_var_or_default('MAVEN_VER','3.9.5')
...
export CASSANDRA_TRUNK_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_TRUNK_GIT_COMMIT_ID','3d15be1d')
...
export JENA_MAIN_GIT_COMMIT_ID := env_var_or_default('JENA_MAIN_GIT_COMMIT_ID','34f77998')
...
export SPARK_MASTER_GIT_COMMIT_ID := env_var_or_default('SPARK_MASTER_GIT_COMMIT_ID','b0576fff')
