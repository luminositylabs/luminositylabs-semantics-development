...
export SCALA_VER := env_var_or_default('SCALA_VER','3.7.2')
...
export SBT_VER := env_var_or_default('SBT_VER','1.11.5')
...
export CASSANDRA_RELEASE_4_1_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_RELEASE_4_1_GIT_COMMIT_ID','cassandra-4.1.9')
export CASSANDRA_RELEASE_4_1_DISTRO_VERSION := env_var_or_default('CASSANDRA_RELEASE_4_1_DISTRO_VERSION','4.1.9')
