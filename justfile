...
export JAVA_VER_DISTRO_23 := env_var_or_default('JAVA_VER_DISTRO_23','23.0.2-zulu')
export JBANG_VER := env_var_or_default('JBANG_VER', '0.123.0')
export KOTLIN_VER := env_var_or_default('KOTLIN_VER','2.1.10')
export SCALA_VER := env_var_or_default('SCALA_VER','3.6.3')
export ANT_VER := env_var_or_default('ANT_VER','1.10.14')
export GRADLE_VER := env_var_or_default('GRADLE_VER','8.12.1')
...
export CASSANDRA_TRUNK_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_TRUNK_GIT_COMMIT_ID','f6a20b0e')
