...
export UBUNTU_TAG := env_var_or_default('UBUNTU_TAG','jammy-20240227')
export JAVA_VER_DISTRO_8 := env_var_or_default('JAVA_VER_DISTRO_8','8.0.402-zulu')
export JAVA_VER_DISTRO_11 := env_var_or_default('JAVA_VER_DISTRO_11','11.0.22-zulu')
export JAVA_VER_DISTRO_17 := env_var_or_default('JAVA_VER_DISTRO_17','17.0.10-zulu')
export JAVA_VER_DISTRO_21 := env_var_or_default('JAVA_VER_DISTRO_21','21.0.2-zulu')
export KOTLIN_VER := env_var_or_default('KOTLIN_VER','1.9.23')
export KSCRIPT_VER := env_var_or_default('KSCRIPT_VER','4.2.3')
export SCALA_VER := env_var_or_default('SCALA_VER','3.4.0')
export ANT_VER := env_var_or_default('ANT_VER','1.10.13')
export GRADLE_VER := env_var_or_default('GRADLE_VER','8.6')
export MAVEN_VER := env_var_or_default('MAVEN_VER','3.9.6')
export SBT_VER := env_var_or_default('SBT_VER','1.9.9')
...
export CASSANDRA_TRUNK_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_TRUNK_GIT_COMMIT_ID','98ca5f8f')
...
export JENA_MAIN_GIT_COMMIT_ID := env_var_or_default('JENA_MAIN_GIT_COMMIT_ID','75b8a4f4')
...
export JENA_RELEASE_5_0_GIT_COMMIT_ID := env_var_or_default('JENA_RELEASE_5_0_GIT_COMMIT_ID','jena-5.0.0')
export JENA_RELEASE_5_0_DISTRO_VERSION := env_var_or_default('JENA_RELEASE_5_0_DISTRO_VERSION','5.0.0')
export SPARK_MASTER_GIT_COMMIT_ID := env_var_or_default('SPARK_MASTER_GIT_COMMIT_ID','51e8634a')
...
export WIDOCO_MAIN_GIT_COMMIT_ID := env_var_or_default('WIDOCO_MAIN_GIT_COMMIT_ID','b5366850')
export WIDOCO_MAIN_DISTRO_VERSION := env_var_or_default('WIDOCO_MAIN_DISTRO_VERSION','1.4.21')
...
build-jena-main-17: build-maven-17
   ...
   if [ "{{do_platform_amd64}}" == "true" ]; then
      time docker image build --platform linux/amd64 -f Dockerfile.ubuntu-jena -t ${IMGTAG}_linux-amd64 --build-arg PREFIX={{prefix}} --build-arg PARENT_TAG=17_linux-amd64 --build-arg JENA_GIT_COMMIT_ID=${JENA_MAIN_GIT_COMMIT_ID} --build-arg JENA_DISTRO_VERSION=${JENA_MAIN_DISTRO_VERSION} .
      if [[ "{{do_push}}" == "true" ]]; then
         docker push ${IMGTAG}_linux-amd64
      fi
   fi
   if [ "{{do_platform_arm64}}" == "true" ]; then
      time docker image build --platform linux/arm64 -f Dockerfile.ubuntu-jena -t ${IMGTAG}_linux-arm64 --build-arg PREFIX={{prefix}} --build-arg PARENT_TAG=17_linux-arm64 --build-arg JENA_GIT_COMMIT_ID=${JENA_MAIN_GIT_COMMIT_ID} --build-arg JENA_DISTRO_VERSION=${JENA_MAIN_DISTRO_VERSION} .
      if [[ "{{do_push}}" == "true" ]]; then
         docker push ${IMGTAG}_linux-arm64
      fi
   fi
...
build-jena-main-21: build-maven-21
   ...
   if [ "{{do_platform_amd64}}" == "true" ]; then
      time docker image build --platform linux/amd64 -f Dockerfile.ubuntu-jena -t ${IMGTAG}_linux-amd64 --build-arg PREFIX={{prefix}} --build-arg PARENT_TAG=21_linux-amd64 --build-arg JENA_GIT_COMMIT_ID=${JENA_MAIN_GIT_COMMIT_ID} --build-arg JENA_DISTRO_VERSION=${JENA_MAIN_DISTRO_VERSION} .
      if [[ "{{do_push}}" == "true" ]]; then
         docker push ${IMGTAG}_linux-amd64
      fi
   fi
   if [ "{{do_platform_arm64}}" == "true" ]; then
      time docker image build --platform linux/arm64 -f Dockerfile.ubuntu-jena -t ${IMGTAG}_linux-arm64 --build-arg PREFIX={{prefix}} --build-arg PARENT_TAG=21_linux-arm64 --build-arg JENA_GIT_COMMIT_ID=${JENA_MAIN_GIT_COMMIT_ID} --build-arg JENA_DISTRO_VERSION=${JENA_MAIN_DISTRO_VERSION} .
      if [[ "{{do_push}}" == "true" ]]; then
         docker push ${IMGTAG}_linux-arm64
      fi
   fi
