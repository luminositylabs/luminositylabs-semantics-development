...
export UBUNTU_TAG := env_var_or_default('UBUNTU_TAG','jammy-20240125')
...
export SBT_VER := env_var_or_default('SBT_VER','1.9.8')
...
export JENA_MAIN_GIT_COMMIT_ID := env_var_or_default('JENA_MAIN_GIT_COMMIT_ID','23c4910a')
