...
export UBUNTU_TAG := env_var_or_default('UBUNTU_TAG','noble-20250529')
...
export KOTLIN_VER := env_var_or_default('KOTLIN_VER','2.1.21')
...
export SBT_VER := env_var_or_default('SBT_VER','1.11.2')
...
export CASSANDRA_TRUNK_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_TRUNK_GIT_COMMIT_ID','7c9af51c')
...
export JENA_MAIN_GIT_COMMIT_ID := env_var_or_default('JENA_MAIN_GIT_COMMIT_ID','fe084c9c')
