...
export GRADLE_VER := env_var_or_default('GRADLE_VER','9.5.0')
export MAVEN_VER := env_var_or_default('MAVEN_VER','3.9.15')
...
export CASSANDRA_TRUNK_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_TRUNK_GIT_COMMIT_ID','aa615369')
