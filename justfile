...
export UBUNTU_TAG := env_var_or_default('UBUNTU_TAG','noble-20250415.1')
...
export JBANG_VER := env_var_or_default('JBANG_VER', '0.126.1')
export KOTLIN_VER := env_var_or_default('KOTLIN_VER','2.1.21')
export SCALA_VER := env_var_or_default('SCALA_VER','3.7.0')
export ANT_VER := env_var_or_default('ANT_VER','1.10.14')
export GRADLE_VER := env_var_or_default('GRADLE_VER','8.14')
...
export CASSANDRA_TRUNK_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_TRUNK_GIT_COMMIT_ID','f80a234d')
...
export CASSANDRA_RELEASE_4_1_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_RELEASE_4_1_GIT_COMMIT_ID','cassandra-4.1.8')
export CASSANDRA_RELEASE_4_1_DISTRO_VERSION := env_var_or_default('CASSANDRA_RELEASE_4_1_DISTRO_VERSION','4.1.8')
export JENA_MAIN_GIT_COMMIT_ID := env_var_or_default('JENA_MAIN_GIT_COMMIT_ID','cf135b4e')
...
export SPARK_MASTER_GIT_COMMIT_ID := env_var_or_default('SPARK_MASTER_GIT_COMMIT_ID','aeff6796')
