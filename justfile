...
export UBUNTU_TAG := env_var_or_default('UBUNTU_TAG','noble-20251013')
...
export JBANG_VER := env_var_or_default('JBANG_VER', '0.134.2')
...
export GRADLE_VER := env_var_or_default('GRADLE_VER','9.2.1')
...
export CASSANDRA_TRUNK_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_TRUNK_GIT_COMMIT_ID','a0f97a91')
