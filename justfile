...
export GRADLE_VER := env_var_or_default('GRADLE_VER','9.4.0')
export MAVEN_VER := env_var_or_default('MAVEN_VER','3.9.14')
export SBT_VER := env_var_or_default('SBT_VER','1.12.5')
...
export CASSANDRA_TRUNK_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_TRUNK_GIT_COMMIT_ID','8d325d50')
