...
export UBUNTU_TAG := env_var_or_default('UBUNTU_TAG','noble-20250910')
...
export JBANG_VER := env_var_or_default('JBANG_VER', '0.131.0')
...
export CASSANDRA_TRUNK_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_TRUNK_GIT_COMMIT_ID','55db3181')
...
export JENA_MAIN_GIT_COMMIT_ID := env_var_or_default('JENA_MAIN_GIT_COMMIT_ID','44cf5a04')
