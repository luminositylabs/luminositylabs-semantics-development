...
export UBUNTU_TAG := env_var_or_default('UBUNTU_TAG','noble-20260210.1')
...
export KOTLIN_VER := env_var_or_default('KOTLIN_VER','2.3.10')
...
export SBT_VER := env_var_or_default('SBT_VER','1.12.3')
...
export CASSANDRA_TRUNK_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_TRUNK_GIT_COMMIT_ID','7532be5c')
