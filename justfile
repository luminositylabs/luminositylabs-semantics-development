...
export UBUNTU_TAG := env_var_or_default('UBUNTU_TAG','jammy-20230624')
export JAVA_VER_DISTRO_8 := env_var_or_default('JAVA_VER_DISTRO_8','8.0.382-zulu')
export JAVA_VER_DISTRO_11 := env_var_or_default('JAVA_VER_DISTRO_11','11.0.20-zulu')
export JAVA_VER_DISTRO_17 := env_var_or_default('JAVA_VER_DISTRO_17','17.0.8-zulu')
export JAVA_VER_DISTRO_20 := env_var_or_default('JAVA_VER_DISTRO_20','20.0.2-zulu')
export KOTLIN_VER := env_var_or_default('KOTLIN_VER','1.9.0')
...
export GRADLE_VER := env_var_or_default('GRADLE_VER','8.2.1')
export MAVEN_VER := env_var_or_default('MAVEN_VER','3.9.3')
export SBT_VER := env_var_or_default('SBT_VER','1.9.3')
...
export CASSANDRA_TRUNK_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_TRUNK_GIT_COMMIT_ID','600f4d9a')
...
export CASSANDRA_RELEASE_4_1_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_RELEASE_4_1_GIT_COMMIT_ID','cassandra-4.1.2')
export CASSANDRA_RELEASE_4_1_DISTRO_VERSION := env_var_or_default('CASSANDRA_RELEASE_4_1_DISTRO_VERSION','4.1.2')
export JENA_MAIN_GIT_COMMIT_ID := env_var_or_default('JENA_MAIN_GIT_COMMIT_ID','f6d1f086')
export JENA_MAIN_DISTRO_VERSION := env_var_or_default('JENA_MAIN_DISTRO_VERSION','4.10.0-SNAPSHOT')
export JENA_RELEASE_4_8_PARENT_TAG := env_var_or_default('JENA_RELEASE_4_8_PARENT_TAG','17')
...
export SPARK_MASTER_GIT_COMMIT_ID := env_var_or_default('SPARK_MASTER_GIT_COMMIT_ID','515dfc16')
...
# Apache Jena recipes
build-jena: build-jena-main-17 build-jena-main-20 build-jena-release-4_8 build-jena-release-4_9
...
build-jena-release-4_8: build-maven-17
...
# Widoco recipes
build-widoco: build-widoco-main-17 build-widoco-main-20
