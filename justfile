...
export JBANG_VER := env_var_or_default('JBANG_VER', '0.127.18')
export KOTLIN_VER := env_var_or_default('KOTLIN_VER','2.2.0')
export SCALA_VER := env_var_or_default('SCALA_VER','3.7.1')
export ANT_VER := env_var_or_default('ANT_VER','1.10.14')
export GRADLE_VER := env_var_or_default('GRADLE_VER','8.14.3')
export MAVEN_VER := env_var_or_default('MAVEN_VER','3.9.11')
export SBT_VER := env_var_or_default('SBT_VER','1.11.3')
...
export CASSANDRA_TRUNK_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_TRUNK_GIT_COMMIT_ID','a866f92f')
