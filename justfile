...
export JBANG_VER := env_var_or_default('JBANG_VER', '0.135.1')
export KOTLIN_VER := env_var_or_default('KOTLIN_VER','2.3.0')
...
export MAVEN_VER := env_var_or_default('MAVEN_VER','3.9.12')
export SBT_VER := env_var_or_default('SBT_VER','1.12.0')
...
export CASSANDRA_TRUNK_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_TRUNK_GIT_COMMIT_ID','d2c48faf')
