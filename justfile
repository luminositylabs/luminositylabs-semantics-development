...
export UBUNTU_TAG := env_var_or_default('UBUNTU_TAG','jammy-20240212')
...
export CASSANDRA_TRUNK_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_TRUNK_GIT_COMMIT_ID','ce963bc9')
...
export SPARK_MASTER_GIT_COMMIT_ID := env_var_or_default('SPARK_MASTER_GIT_COMMIT_ID','ed6fe4fc')
